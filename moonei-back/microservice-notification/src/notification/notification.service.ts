...
export class NotificationService {
    ...
    */
    ...
    Metodo para enviar una nueva contraseña al usuario
    */
    sendInviteMember(project: any, user: any) {

        return this.eventEmitter2.emit('project.invitemember', project, user);
    }
        /*
    Metodo para enviar una nueva contraseña al usuario
    */
    sendInviteNewUser(userEmailInvited: any, passTemp: any) {
        return this.eventEmitter2.emit('auth.newUser', userEmailInvited, passTemp);
    }
